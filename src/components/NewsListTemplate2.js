...
class NewsListTemplate2 extends Component {  
    render() {
            ...
            <div className="row">
                {
                    news.length > 0 ? (  
                        news.map((item, ix) => {
                            return (
                                <div className="col-md-4" key={ix}>
                                    <div className="post">
                                        <a className="post-img" href={item.Url}><img src={item.Thumbnail} alt={item.Title} /></a>
                                        <div className="post-body">
                                        <div className="post-meta">
                                            <a className={ `post-category ${Utils.getSectionClassName(item.SectionId)}` }
...
export default NewsListTemplate2; 